...
PYBIND11_MODULE(pybind_mlir, m) {
  ...
  py::class_<mlir::OpBuilder, mlir::Builder>(m, "OpBuilder")
      ...
      //                                            right);
      //     })
      .def("createFooPrint2Op", [](mlir::OpBuilder& b, mlir::Location location,
                                mlir::Value value) {
        return b.create<mlir::foo::Print2Op>(location, value);
      })
      .def("createFooPrintOp", [](mlir::OpBuilder& b, mlir::Location location,
                                mlir::Value value) {
  ...
  py::class_<mlir::foo::Print2Op>(m, "FooPrint2Op")
      .def("getOperation", &mlir::foo::Print2Op::getOperation);

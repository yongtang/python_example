...
class MLIRNodeVisitor(ast.NodeVisitor):
    ...
    def visit_Call(self, node: ast.Call):
        ...
        return self.builder.createFooPrintOp(location, value)
    ...
    def visit_Num(self, node: ast.Num):
        ...
        return self.builder.createFooConstOp(
            location, self.builder.getOpaqueType("foo", "foo"), value
        )
